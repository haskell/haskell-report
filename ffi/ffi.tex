...
%\def\Version{\relax}
\def\Version{\\(Release Candidate 12)}
\begin{DRAFT}%
{
  \gdef\Version{%
    \\
    \textbf{--- DRAFT ---}\\[1ex]
    \ttfamily\scriptsize
    $\relax$Id: ffi.tex,v 1.46 2003/08/01 06:43:56 chak Exp $\relax$%
    \ignorespaces}
  }
\end{DRAFT}
...
program terminates.  Whether a finalizer may call back into the Haskell system
...
\item[newForeignPtr ::\ FinalizerPtr a -> Ptr a -> IO (ForeignPtr a)]
  Convenience function that turns a plain memory reference into a foreign
