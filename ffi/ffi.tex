...
% TODO:
% * Do we want `isAlreadyExistsErrorType' etc functions (otherwise, an
%   ErrorType needs to be wrapped into IOError before it can be inspected)
...
%\def\Version{\relax}
\def\Version{\\(Release Candidate 2)}
\begin{DRAFT}%
{
  \gdef\Version{%
    \\
    \textbf{--- DRAFT ---}\\[1ex]
    \ttfamily\scriptsize
    $\relax$Id: ffi.tex,v 1.24 2002/02/04 09:37:12 chak Exp $\relax$%
    \ignorespaces}
  }
\end{DRAFT}
...
their feedback.  We are grateful to Martin D. Kealey for errata to this report.
