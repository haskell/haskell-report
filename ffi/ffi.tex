...
%\def\Version{\relax}
\def\Version{\\(Release Candidate 1)}
\begin{DRAFT}%
{
  \gdef\Version{%
    \\
    \textbf{--- DRAFT ---}\\[1ex]
    \ttfamily\scriptsize
    $\relax$Id: ffi.tex,v 1.21 2002/01/10 10:16:21 chak Exp $\relax$%
    \ignorespaces}
  }
\end{DRAFT}
...
We heartly thank the kind people who helped us with their comments and
